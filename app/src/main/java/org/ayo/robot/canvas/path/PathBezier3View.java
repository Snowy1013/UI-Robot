...
public class PathBezier3View extends ShapeView {
    public PathBezier3View(Context context) {
        super(context);
        init();
    }

    public PathBezier3View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PathBezier3View(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public PathBezier3View(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
